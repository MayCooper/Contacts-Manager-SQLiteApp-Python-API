...
class Contacts:
    ...
    def __init__(self, root):
        ...
        ttk.style.configure('Treeview.Heading', font=('Lato',12,'bold'))
    ...
    def create_label_frame(self):
        labelframe = LabelFrame(self.root, text='Add New Contact', bg='sky blue', font = 'Lato 12')
        labelframe.grid(row=0, column=1, padx=8, pady=8, sticky='ew')
        Label(labelframe, text='Lead Name:', bg='green', fg='white').grid(row=1, column=1, sticky=W, pady=2, padx=15)
        ...
        Label(labelframe, text='Phone Number:', bg='brown', fg='white').grid(row=3, column=1, sticky=W, pady=2, padx=15)
        self.numfield = Entry(labelframe)
        self.numfield.grid(row=3, column=2, sticky=W, padx=5, pady=2)
        Button(labelframe, text='Add Lead Now', command=self.on_add_contact_button_clicked, bg='pink', fg='black').grid(row=4, column=2, sticky=E, padx=5, pady=6)
    ...
    def on_modify_selected_button_clicked(self):
        ...
        try:
            if len(self.tree.selection()) == 0:
                raise IndexError('No Item Selected To Modify')
            self.open_modify_window()
        except IndexError as e:
    ...
    def delete_contacts(self):
        ...
        self.message['text'] = '{} Was Deleted'.format(name)
        self.view_contacts()
